    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.backgroundTertiary }} edges={['top']}>
      ...
      >
        <View style={{ backgroundColor: theme.cardBackground, borderRadius: 12, padding: 20, marginBottom: 20 }}>
          <Text style={{ color: theme.textSecondary, fontFamily: 'questrial', fontSize: 14, lineHeight: 20, marginBottom: 16, fontStyle: 'italic' }}>
          ...
          <View style={{ marginBottom: 24 }}>
            ...
            <Text style={{ color: theme.text, fontFamily: 'questrial', fontSize: 16, lineHeight: 24, marginBottom: 12 }}>
              We collect information about you in a variety of ways:
            </Text>
            <Text style={{ color: theme.text, fontFamily: 'questrial', fontSize: 16, lineHeight: 24, marginBottom: 8 }}>
