...
const CustomPollComponent = ({ message, poll }: CustomPollComponentProps) => {
        ...
        {poll?.options?.map((option, index) => {
          ...
          return (
            <TouchableOpacity
              key={option.id || index}
              style={{
                backgroundColor: isVoted ? theme.backgroundSecondary : theme.cardBackground,
                borderRadius: 12,
                marginBottom: 10,
                overflow: 'hidden',
...
export default CustomPollComponent;